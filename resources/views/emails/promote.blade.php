                ...
                <div style="border: 1px solid transparent; color: black;">
                    ...
                    <div class="details">
                        <div class="details-box">
                            <div class="firstbox">Promoted Business</div>
                            <div class="secondbox">{{$proBusiness}}</div>
                        </div>
                        ...
                        <div class="details-box">
                            <div class="firstbox">Promotion Plan</div>
                            <div class="secondbox">{{$planName}}</div>
                        </div>

                        <div class="details-box">
                            <div class="firstbox">Starting Date</div>
                            <div class="secondbox">{{$created_at}}</div>
                        </div>

                        <div class="details-box">
                            <div class="firstbox">Expiry Date</div>
                            <div class="secondbox">{{$expiry_date}}</div>
                        </div>

                        <div class="details-box">
                            <div class="firstbox">Duration</div>
                            <div class="secondbox">{{$duration}}</div>
                        </div>
                    </div>

                    <p>Thanks for your patronage,</p>
                    <p style="margin-top:20px;">Kobosquare Team</p>
                    <p style="margin-top:20px;">If you have any issues or complaints regarding any transaction, kindly send us an email at  <a href="mailto:support@kobosquare.com">support@kobosquare.com</a></p>
