        ...
        <tr>
            <td class="content">
                <div style="border: 1px solid transparent; color: black; padding: 10px 15px 0 0">
                    ...
                    <div style="margin-top:20px;">Confirm your Identity</div>
                    {{-- <div style="margin-top:20px">You are receiving this email because you log into your account on {{ $currentDate }}.</div> --}}
                    <div style="margin-top:20px">
                        @php
                            use Carbon\Carbon;
                            $formattedDate = Carbon::parse($currentDate)->format('l, F j, Y g:i A');
                        @endphp
                        You are receiving this email because you logged into your account on {{ $formattedDate }}.
                    </div>
